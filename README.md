...
| Command            | Description                                      |
|--------------------|--------------------------------------------------|
| `conduit run`      | Execute pipeline (with automatic preflight)      |
...
**Key Features:**
- ✅ Auto-preflight validation before every run
- ✅ Unique run IDs for tracking and debugging
- ✅ Comprehensive health checks (connections, schema, compatibility)
- ✅ Enhanced manifest logging with preflight metadata
